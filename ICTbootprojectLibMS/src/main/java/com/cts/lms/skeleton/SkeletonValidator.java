...
public class SkeletonValidator {
	...
	public SkeletonValidator() {
		validateClassName("com.cts.lms.BookApplication");
		validateClassName("com.cts.lms.controller.BookController");
		validateClassName("com.cts.lms.exception.BookException");
		validateClassName("com.cts.lms.exception.BookExceptionAdvice");
		validateClassName("com.cts.lms.model.Book");
		validateClassName("com.cts.lms.model.BookQuery");
		validateClassName("com.cts.lms.service.BookService");
		
		
		validateMethodSignature("showSearchPage:String,submitSearchPage:String,showFeedbackPage:String,submitFeedbackPage:String","com.cts.lms.controller.BookController");
		validateMethodSignature("getBookOnTitle:Book,getBooksOnSubject:List","com.cts.lms.service.BookService");
